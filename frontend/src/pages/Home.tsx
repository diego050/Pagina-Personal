                        ...
                        <div className="max-w-7xl mx-auto">
                            ...
                            >
                                {['Todos', 'Estrategia', 'Tech & Web', 'Growth'].map((filter, i) => (
                                    <button key={filter} className={`px-4 py-1.5 rounded-full text-sm font-medium transition-colors whitespace-nowrap ${i === 0 ? 'bg-cyan-500 text-black' : 'bg-zinc-800/50 border border-zinc-700 text-zinc-400 hover:text-white'}`}>
                                        {filter}
                                    </button>
                                ))}
                            </motion.div>
            ...
            >
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex justify-center gap-8">
                        <a href="https://www.linkedin.com/in/diego-baz%C3%A1n/" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-white transition-colors">
                            <Linkedin className="w-8 h-8" />
                        </a>
                        {/* WhatsApp */}
                        <a href="https://wa.me/51950051707" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-white transition-colors">
